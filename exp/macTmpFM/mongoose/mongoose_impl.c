...
struct attribute s_files_attributes[] = {
  {"size", "int", NULL, offsetof(struct files, size), 0, false},
  {"name", "string", NULL, offsetof(struct files, name), 80, false},
  {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_action s_apihandler_delete = {{"delete", "action", false, 0, 0, 0UL}, glue_check_delete, glue_start_delete};
struct apihandler_array s_apihandler_files = {{"files", "array", false, 0, 0, 0UL}, s_files_attributes, sizeof(struct files), (bool (*)(void *, size_t)) glue_get_files, (void (*)(void *, size_t)) glue_set_files};
struct apihandler_file s_apihandler_upload = {{"upload", "file", false, 0, 0, 0UL}, glue_file_read_upload, glue_file_write_upload};

static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_delete,
  (struct apihandler *) &s_apihandler_files,
  (struct apihandler *) &s_apihandler_upload
};
