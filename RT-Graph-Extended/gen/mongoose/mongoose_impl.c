...
struct attribute s_accel_attributes[] = {
  {"x", "double", NULL, offsetof(struct accel, x), 0, false},
  {"y", "double", NULL, offsetof(struct accel, y), 0, false},
  {"z", "double", NULL, offsetof(struct accel, z), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};
struct attribute s_angular_attributes[] = {
  {"yaw", "double", NULL, offsetof(struct angular, yaw), 0, false},
  {"pitch", "double", NULL, offsetof(struct angular, pitch), 0, false},
  {"roll", "double", NULL, offsetof(struct angular, roll), 0, false},
  {NULL, NULL, NULL, 0, 0, false}
};

struct apihandler_data s_apihandler_accel = {{"accel", "data", true, 0, 0, 0UL}, s_accel_attributes, sizeof(struct accel), (void (*)(void *)) glue_get_accel, NULL};
struct apihandler_data s_apihandler_angular = {{"angular", "data", true, 0, 0, 0UL}, s_angular_attributes, sizeof(struct angular), (void (*)(void *)) glue_get_angular, NULL};

static struct apihandler *s_apihandlers[] = {
  (struct apihandler *) &s_apihandler_accel,
  (struct apihandler *) &s_apihandler_angular
};
